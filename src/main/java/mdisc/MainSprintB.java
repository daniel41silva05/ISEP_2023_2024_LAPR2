...
public class MainSprintB {
    public static void main(String[] args) {
        try {
            // Ler o grafo da US13
            String ficheiro = "datasets mdisc\\quarta_feira.csv";
            ImplementationSprintB.gerarOutputExcel(ficheiro, "src\\main\\java\\mdisc\\output_menor_caminho.csv");
            Aresta[] resultado = ImportarCsv.lerGrafoDeCSV(ficheiro).toArray(new Aresta[0]);

            ImplementationSprintB.generateDotFile(resultado, "src\\main\\java\\mdisc\\input_grafo.dot");
            ImplementationSprintB.renderDotFile("src\\main\\java\\mdisc\\input_grafo.dot", "src\\main\\java\\mdisc\\input_grafo.png");
