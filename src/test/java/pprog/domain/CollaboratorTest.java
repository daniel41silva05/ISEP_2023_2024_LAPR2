...
class CollaboratorTest {
    ...
    void testEquals() {
        ...
        Collaborator collaborator1 = new Collaborator("Daniel Silva", new Date(), new Date(), "123 Street", 123456789,
                "daniel.silva@example.com", IdDocType.PASSPORT, 123456, new Job("Software Engineer", "Developing software applications"));
    ...
    void testClone() {
        ...
        Collaborator originalCollaborator = new Collaborator("Daniel Silva", new Date(), new Date(), "123 Street", 123456789,
                "daniel.silva@example.com", IdDocType.CITIZEN_CARD, 123456, new Job("Software Engineer", "Developing software applications"));
