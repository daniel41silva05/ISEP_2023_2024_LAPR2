...
![Sequence Diagram - Partial - Get Task Category List](svg/us007-sequence-diagram-partial-get-task-category-list.svg)
...
![Sequence Diagram - Partial - Create Task](svg/us007-sequence-diagram-partial-create-task.svg)
